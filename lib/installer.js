...
function acquireNJ(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (process.platform == "win32") {
            yield exec.exec("sh", [path.join("config", "prepare-win-install.sh")], {
                cwd: extPath,
                env: Object.assign(Object.assign({}, process.env), { URLGETTER: "curl" })
            });
            yield exec.exec(path.join("config", "install.bat"), [], {
                cwd: extPath,
                env: Object.assign(Object.assign({}, process.env), { SMLNJ_HOME: extPath })
            });
        }
        else {
